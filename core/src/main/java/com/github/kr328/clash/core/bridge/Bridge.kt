...
object Bridge {
    ...
    external fun nativeInstallSocketPolicy(cb: TunInterface, tcpOnly: Boolean)
    external fun nativeClearSocketPolicy()
    ...
    external fun nativeHealthCheckGroup(completable: CompletableDeferred<Unit>, name: String)
    external fun nativeHealthCheckProxy(completable: CompletableDeferred<Unit>, group: String, proxy: String)
