...
require (
	...
	github.com/metacubex/mipstack v0.0.0-20260902082959-c7e60ae7a02a // indirect
...
replace github.com/metacubex/mihomo => github.com/l0nelynx/cheezy-core v0.0.0-20260906152255-3167c6fe9e98
