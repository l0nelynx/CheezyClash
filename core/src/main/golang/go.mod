...
require (
	...
	github.com/metacubex/amneziawg-go v0.0.0-20260726091836-16af3a7a9a29 // indirect
...
replace github.com/metacubex/mihomo => github.com/l0nelynx/cheezy-core v0.0.0-20260813190839-23e7db405400
